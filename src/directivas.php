...
class directivas extends \gamboamartin\template\directivas {
     ...
     * @return array|string
     */
    public function email_required(bool $disable, string $name, string $place_holder, stdClass $row_upd, bool $value_vacio): array|string
    {
        $email = parent::email_required($disable, $name, $place_holder, $row_upd, $value_vacio); // TODO: Change the autogenerated stub
        if(errores::$error){
